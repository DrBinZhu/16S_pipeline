...
# functions
{
  ...
  ######### heat map ########
  heatmap_plot <- function(reads_table, metadata, type_th = 0.1, taxa_num = 5, abundant_taxa_number = 20, width=18, height=8) { # pass proportion data, samples on columns, taxa on rows.
    # reads_table = reads_table_all
...
if (ncol(metadata_all) == 1) {
  ...
  # heatmap
  heatmap_plot(reads_table_all, metadata_all,type_th = 0.1, taxa_num = 5, width=8, height=4) 
