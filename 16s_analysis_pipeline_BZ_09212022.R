...
# read data
{
  ...
  if (sum(colnames(reads_table_all) != row.names(metadata_all)) != 0) {
  ...
  
  {
    ...
    parameter_1 = as.numeric(parameter_list$value[1]);parameter_2 = as.numeric(parameter_list$value[2]);parameter_3 = as.numeric(parameter_list$value[3]);
    parameter_4 = as.numeric(parameter_list$value[4]);parameter_5 = as.numeric(parameter_list$value[5]);parameter_6 = as.numeric(parameter_list$value[6]);
    parameter_7 = as.numeric(parameter_list$value[7]);parameter_8 = as.numeric(parameter_list$value[8]);parameter_9 = as.numeric(parameter_list$value[9]);
    parameter_10 = as.numeric(parameter_list$value[10]);parameter_11 = as.numeric(parameter_list$value[11]);parameter_12 = as.numeric(parameter_list$value[12]);
    parameter_13 = as.numeric(parameter_list$value[13]);parameter_14 = as.numeric(parameter_list$value[14]);parameter_15 = as.numeric(parameter_list$value[15]);
    parameter_16 = as.numeric(parameter_list$value[16]);parameter_17 = as.numeric(parameter_list$value[17]);parameter_18 = as.numeric(parameter_list$value[18]);
    parameter_19 = as.numeric(parameter_list$value[19]);parameter_20 = as.character(parameter_list$value[20]);
...
# functions
{
  ...
  barplot <- function(reads_table, type_th = 0.1, taxa_num = 9) { # pass proportion data, samples on columns, taxa on rows.
  ...
  One_factor_script = function(reads_table, metadata, ref_group, order) {
    ...
    # composition bar plot
      ...
      barplot_result$p
      ggsave('bar_plot.pdf',width=parameter_5, height=parameter_6)
